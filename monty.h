...
/**
* struct bus_s - Variables - args, file, line content, and flag for stack/queue
* @arg: Value of the argument
* @file: Pointer to the monty file being processed
* @content: Line content from the monty file
* @lifi: Flag indicating whether stack or queue operations are to be performed
*
* Description: Carries values and information throughout the program
*/
...
*
* Description: Opcode and its corresponding function for stack,
* queues, LIFO, FIFO
* Holberton project
*/
